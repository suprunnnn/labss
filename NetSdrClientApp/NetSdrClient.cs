...
namespace NetSdrClientApp
{
    public class NetSdrClient
    {
        ...
        // ✅ Статичний метод — не використовує нестатичні поля
        private static void _udpClient_MessageReceived(object? sender, byte[] e)
        {
            ...
            Console.WriteLine("Samples received: " +
                string.Join(" ", body.Select(b => Convert.ToString(b, toBase: 16))));
        ...
        private void _tcpClient_MessageReceived(object? sender, byte[] e)
        {
            ...
            Console.WriteLine("Response received: " +
                string.Join(" ", e.Select(b => Convert.ToString(b, toBase: 16))));
        }
    }
}
